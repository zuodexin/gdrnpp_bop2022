...
OUTPUT_DIR = "output/gdrn/tless/sdvae_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tless"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
    ...
    POSE_NET=dict(
        ...
        GEO_HEAD=dict(
            ...
            INIT_CFG=dict(
                ...
                in_dim=4,  # this is num out channels of backbone conv feature
            ),
            NUM_REGIONS=64,
